...
class AbiVecs():
    ...
    def insert_sym_if_not_exist(self, sym: str, so: str):
    ...
    def gen_build_data(self, abi_data: list):
        for whl in abi_data:
    ...
    def abi2vec_single(self, whl: dict, size: int) -> list:
    ...
    def abi2vec_many(self, abi_data: list):
